      ...
      <div className="about__story">
        <div className="container">
          ...
          <div className="about__content story-content">
            <p>
              Hello and welcome to my portfolio website! My name is Soojeong
              Park and I'm thrilled to share my journey with you. Let me take
              you through my story, from being an elementary school teacher to
              pursuing my passion for web development.
            </p>
            <p>
              I started my career as an elementary school teacher in South
              Korea, where I spent three and a half years fostering young minds
              and creating a nurturing learning environment. In 2019, I embarked
              on a new adventure and became a long-term substitute teacher for
            ...
            <p>
              ...
              JavaScript and React. Currently, I'm expanding my skills by
              delving into Sass, React Router, and Redux. My focus remains
              unwavering as I continue to learn, build, and evolve towards my
              goal of becoming a frontend web developer.
            </p>
            <div className="img-container">
            ...
            <p>
              ...
              invaluable skills. Managing and communicating with 30+ students
              and their parents throughout the school year honed my ability to
              multitask and pay close attention to detail. Reviewing and grading
              assignments and teaching lessons sharpened my time management
              skills and reinforced my commitment to delivering high-quality
              work.
            </p>
            <p>
              Teaching has always held a special place in my heart, as it was my
              childhood dream job. However, nothing has ignited the same level
              of passion in my adult life as coding and building websites. The
              joy and confidence I experience when creating something from
              scratch, and the knowledge that it has the potential to be used
              and enjoyed by many people, is truly fulfilling.
            </p>
            <p>
              Thank you for taking the time to learn about me and my journey.
              I'm excited about the possibilities that lie ahead and look
              forward to collaborating, creating, and making a positive impact
